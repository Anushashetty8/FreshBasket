            ...
            <div className="text-indigo-500" onClick={(e) => e.stopPropagation()}>
              {!cartItems[product._id] ? (
                ...
                >
                  ...
                  >
                    <path
                      d="M0.583 0.583h2.333l1.564 7.81a1.17 1.17 0 0 0 1.166 0.94h5.67a1.17 1.17 0 0 0 1.167-0.94l0.933-4.893H3.5m2.333 8.75a0.583 0.583 0 1 1-1.167 0 0.583 0.583 0 0 1 1.167 0m6.417 0a0.583 0.583 0 1 1-1.167 0 0.583 0.583 0 0 1 1.167 0"
                      stroke="#615fff"
                      strokeLinecap="round"
